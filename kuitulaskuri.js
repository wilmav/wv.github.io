...
const SAMPLE_LISTS = {
    ...
    { name: "Porkkana", fiber: 2.5, link: "https://fineli.fi/fineli/fi/foods?q=porkkana" },
  ],
  sv: [
    ...
    { name: "Hårt knäckebröd", fiber: 23.0, link: "https://fineli.fi/fineli/fi/foods?q=hapankorppu" },
    ...
    { name: "Böna, kidneyböna, kokt", fiber: 7.4, link: "https://fineli.fi/fineli/fi/foods?q=kidneypapu" },
    { name: "Morot", fiber: 2.5, link: "https://fineli.fi/fineli/fi/foods?q=porkkana" },
  ],
  en: [
    ...
    { name: "Crispbread", fiber: 23.0, link: "https://fineli.fi/fineli/fi/foods?q=hapankorppu" },
    { name: "Bran, oat bran", fiber: 17.5, link: "https://fineli.fi/fineli/fi/foods?q=kauralese" },
    ...
    { name: "Carrot", fiber: 2.5, link: "https://fineli.fi/fineli/fi/foods?q=porkkana" },
  ]
};
